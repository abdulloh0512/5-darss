...
function Home() {
  ...
  async function getData(url: string) {
    ...
    const d = await resp.json().finally(() => {
      setLoading(false);
    });
    setData(d);
  }
  ...
  return (
    <div>
      <div className="w-[1200px] flex flex-col mx-auto pt-20">
        ...
        {loading ? (
          <BeatLoader className="text-center flex justify-center pt-[50px]" color="#36d7b7" />
        ) : (
          <div className="w-[1200px] mt-10 flex flex-wrap gap-5 justify-center">
            {data.length &&
